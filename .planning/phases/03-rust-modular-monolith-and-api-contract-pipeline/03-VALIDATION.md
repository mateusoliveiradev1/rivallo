...
| 03-06-02 | 06 | 5 | DATA-02 | T-03-08 | Client drift verifier consumes the writer interface, uses isolated output, and rejects hand-authored schema duplicates. | Node integration | `pnpm contracts:client:generate && pnpm contracts:client:check && pnpm test -- tooling-tests/contracts-client-generation.test.mjs` | ❌ created by task | ⬜ pending |
