...
| 03-08-01 | 08 | 7 | DATA-02 | T-03-12 | The approved pinned generator emits only D-10's minimum types/metadata/Fetch-client inventory and the writer rejects an out-of-scope emitted module without post-processing generated contents. | Node integration + generated-inventory regression | `pnpm test -- tooling-tests/contracts-client-generation.test.mjs && pnpm contracts:client:generate && pnpm contracts:client:check` | ❌ extended by task | ⬜ pending |
| 03-08-02 | 08 | 7 | DATA-02 | T-03-13, T-03-14 | The public package entrypoint exports generator-owned client symbols, package-source scope fences catch prohibited mechanisms, and isolated drift verification leaves tracked bytes unchanged. | Node integration + package import | `pnpm test -- tooling-tests/contracts-client-generation.test.mjs tooling-tests/phase-3-scope.test.mjs && pnpm contracts:client:check && pnpm check` | ❌ extended by task | ⬜ pending |
