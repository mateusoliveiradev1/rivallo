...
**Impact on plan:** The adjustment was required to satisfy the plan's bounded overflow contract at 1366×768; it introduced no new abstraction, dependency, or scope.
...
- Commits `4943800`, `f6f8514`, and `c2219fa` exist in Git history.
