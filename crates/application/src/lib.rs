...
pub use rivallo_domain::{
    ...
    ClubProfileProjection, ClubReadinessProjection, ClubReadinessRequirement, ClubReadinessStatus,
    ...
    EvaluationLayerManifest, EvaluationLayerPackage, EvaluationLayerProvenance,
    EvaluationLayerValidation, ExplainableRating, ExternalPlayerState, Formation,
    ...
    PlayerSportingProfile, PlayerStatisticsProjection, PlayerTrainingProfile, PortraitRecipe,
    PortraitUpload, Position, PositionRatingProjection, PotentialEstimate, PreferredFoot,
    ProfileWorld, RATING_SCALE_VERSION, RatingFactor, RatingFactorImpact, RatingKind,
    RatingSnapshot, ResolvedWorldDatabase, RoleRatingProjection, ScoutingAssessment, SeasonRecord,
    SquadRole, TACTICAL_PLAN_SCHEMA_VERSION, TacticalApproach, TacticalLibraryCommand,
    TacticalLine, TacticalMatchSnapshot, TacticalModelConfig, TacticalModelSnapshot,
    TacticalPlanEvent, TacticalPlanPreview, TacticalPlanProposal, TacticalPlanSnapshot,
    TacticalPlanUpdate, TacticalPlayerPlacement, TacticalSide, TacticalStrategyConfig,
    TacticalStrategyPresetId, TacticalStrategyPresetSummary, TacticalVariationLibrarySnapshot,
    TacticalZone, WorldEntityKind, WorldPackageData, apply_evaluation_import,
    compose_evaluation_layer, evaluate_coach_creation, evaluation_layer_canonical_bytes,
    project_club_readiness, project_coach_profile, rollback_evaluation_import,
    validate_evaluation_layer, validate_portrait,
};
pub use table_view::{
