...
pub use rivallo_domain::{
    ...
    ClubProfileProjection, ClubTacticalIdentityProjection, CoachAppearance, CoachAttributeSet,
    CoachBackground, CoachCreatorDraft, CoachDevelopmentProfile, CoachProfileProjection,
    CoachSportingProfile, ContentPackage, ContractSummary, CustomFormationIdentity,
    DataPackageType, EntityProfileReference, ExplainableRating, ExternalPlayerState, Formation,
    ...
    WorldPackageData, validate_portrait,
};
pub use table_view::{
